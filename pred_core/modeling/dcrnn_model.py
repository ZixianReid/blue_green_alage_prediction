...
class Seq2SeqAttrs:
    def __init__(self, adj_mx, cfg):
        self.adj_mx = adj_mx
        self.max_diffusion_step = cfg.MODEL.MAX_DIFFUSION_STEP
        self.cl_decay_steps = cfg.MODEL.CL_DECAY_STEPS
        self.filter_type = cfg.MODEL.FILTER_TYPE
        self.num_nodes = cfg.MODEL.NUM_NODES
        self.num_rnn_layers = cfg.MODEL.NUM_RNN_LAYERS
        self.rnn_units = cfg.MODEL.RNN_UNITS
...
class EncoderModel(nn.Module, Seq2SeqAttrs):
    def __init__(self, adj_mx, cfg):
        ...
        Seq2SeqAttrs.__init__(self, adj_mx, cfg)
...
class DecoderModel(nn.Module, Seq2SeqAttrs):
    def __init__(self, adj_mx, cfg):
        ...
        self.horizon = cfg.MODEL.HORIZON  # for the decoder
...
class DCRNNModel(nn.Module, Seq2SeqAttrs):
    def __init__(self, adj_mx, cfg):
        nn.Module.__init__(self)
        Seq2SeqAttrs.__init__(self, adj_mx, cfg)
        self.encoder_model = EncoderModel(adj_mx, cfg)
        self.decoder_model = DecoderModel(adj_mx, cfg)
        self.cl_decay_steps = cfg.MODEL.CL_DECAY_STEPS
    ...
    def forward(self, inputs, labels=None, batches_seen=None):
        ...
        # logger.debug("Encoder complete, starting decoder")
        outputs = self.decoder(encoder_hidden_state, labels, batches_seen=batches_seen)
        # logger.debug("Decoder complete")
        return outputs
